...
: ${AMENT_CURRENT_PREFIX:="/workspace/ros_ws/install/hmi_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hmi_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hmi_bridge/environment/path.sh"
